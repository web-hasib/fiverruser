...
const CasesPage = () => {
  ...
  const handleCreateCase = (caseType: string) => {
    console.log("Creating case of type:", caseType);
    // Future logic to handle case creation
  };
  ...
  return (
    <Container>
      <div className="space-y-6 pb-6">
        {/* Top Header */}
        <div className="flex justify-between items-center pr-2 pt-4">
          <Heading title="Cases" />
          <Button
            onClick={() => {
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white  px-6 h-auto font-bold flex items-center gap-2 shadow-lg shadow-blue-600/20"
          >
        ...
        {/* Data Table */}
        <div className="rounded-xl! bg-primary border border-primary-foreground/5 shadow-2xl shadow-black/20 overflow-hidden">
          <DataTable
            columns={columns}
            data={mockCases}

    ...
    <div className="flex flex-col gap-6 mb-6">
      ...
      <div className="bg-card border border-border/50 rounded-xl p-6 flex flex-col md:flex-row justify-between gap-6 relative overflow-hidden">
        ...
        <div className="flex flex-row md:flex-col items-center md:items-end justify-start gap-2">
          <Button variant="default" className="bg-blue-600 hover:bg-blue-700 text-white font-bold h-9 px-4 w-36 justify-center text-xs">
            <Edit2 className="size-3.5 mr-2" /> Edit Profile
          </Button>
          <Button variant="outline" className="font-bold h-9 px-4 border-border/50 bg-card hover:bg-accent text-foreground w-36 justify-center text-xs">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <Button className="h-9 px-4 bg-blue-600 hover:bg-blue-700 text-white text-[11px] font-bold transition-all">
          <Plus className="size-3.5 mr-1.5" /> Start New Session
        </Button>
        
        <Button variant="outline" className="h-9 px-4 border-emerald-500/30 bg-emerald-500/5 text-emerald-500 hover:bg-emerald-500/10 hover:text-emerald-400 text-[11px] font-bold transition-all">
          <Calendar className="size-3.5 mr-1.5" /> Booked Appointment
        </Button>

        <Button variant="outline" className="h-9 px-4 border-blue-500/30 bg-blue-500/5 text-blue-500 hover:bg-blue-500/10 hover:text-blue-400 text-[11px] font-bold transition-all">
          <MessageSquare className="size-3.5 mr-1.5" /> Send Message
        </Button>

        <Button variant="outline" className="h-9 px-4 border-purple-500/30 bg-purple-500/5 text-purple-500 hover:bg-purple-500/10 hover:text-purple-400 text-[11px] font-bold transition-all">
        ...
        <Button variant="outline" className="h-9 px-4 border-amber-500/30 bg-amber-500/5 text-amber-500 hover:bg-amber-500/10 hover:text-amber-400 text-[11px] font-bold transition-all">

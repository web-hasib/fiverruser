...
export default function TermsOfServicePage() {
  return (
    <div className="min-h-screen my-24 text-black p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">Terms of Service</h1>
        <p className="text-gray-600">Last updated: 23 February 2026</p>
      </div>
      
      <div className="space-y-8">
        <section>
          <h2 className="text-xl font-bold mb-2">1. Acceptance of Terms</h2>
          <p>y accessing or using MedAI Pro, you agree to these Terms of Service. If you do not agree, please do not use the platform.</p>
        </section>

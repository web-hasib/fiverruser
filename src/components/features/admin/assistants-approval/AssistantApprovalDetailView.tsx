...
interface AssistantApprovalDetailViewProps {
    assistant: {
        name: string;
        createdBy: string;
        specialty: string;
...
export default function AssistantApprovalDetailView({
    assistant,
    onBack,
    onApprove,
    onReject,
}: AssistantApprovalDetailViewProps) {
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button
                        onClick={onReject}
                        className="px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-semibold transition-colors shadow-lg shadow-red-500/20"
                    >
                        Rejected Assistance
                    </button>
                    <button

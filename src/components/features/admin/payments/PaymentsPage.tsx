...
const SUBSCRIPTIONS = [
    { id: 1, user: "Dr. Csúja Nándor Rahman", plan: "Team", amount: "$29/mo", billing: "Monthly", status: "Paid", renewal: "2026-04-12" },
    { id: 2, user: "Dr. Csúja Nándor Rahman", plan: "Team", amount: "$29/mo", billing: "Annual", status: "Expired", renewal: "2026-04-12" },
    { id: 3, user: "Dr. Csúja Nándor Rahman", plan: "Pro", amount: "$29/mo", billing: "Monthly", status: "Paid", renewal: "2026-04-12" },
    { id: 4, user: "Dr. Csúja Nándor Rahman", plan: "Starter", amount: "$29/mo", billing: "Monthly", status: "Paid", renewal: "2026-04-12" },
    { id: 5, user: "Dr. Csúja Nándor Rahman", plan: "Team", amount: "$29/mo", billing: "Annual", status: "Expired", renewal: "2026-04-12" },
    { id: 6, user: "Dr. Csúja Nándor Rahman", plan: "Pro", amount: "$29/mo", billing: "Monthly", status: "Expired", renewal: "2026-04-12" },
];

...
export default function DeleteTeamModal({ open, teamName, onClose, onConfirm }: DeleteTeamModalProps) {
                ...
                <div className="flex items-start gap-3 bg-red-500/10 border border-red-500/30 rounded-lg px-4 py-3">
                    ...
                    <div className="text-xs space-y-0.5">
                        ...
                        <p className="text-muted-foreground">
                            You are about to permanently delete &ldquo;{teamName}&rdquo;
                        </p>
                    </div>
                </div>

...
const ContentTab = () => {
  ...
  return (
    <div className="flex flex-col gap-2 md:gap-4 h-full flex-1 min-h-0">
      {/* Hidden File Input */}
      <input
        type="file"
        ref={fileInputRef}
      ...
      <div className="flex-1 flex flex-col bg-card border border-border rounded-xl overflow-hidden min-h-[250px] md:min-h-[300px]">
        ...
        <div className="flex-1 flex flex-col p-4 md:p-6 min-h-0">
          <textarea
            className="w-full flex-1 min-h-0 bg-transparent border-none outline-none resize-none text-foreground text-sm placeholder:text-muted-foreground/50 custom-scrollbar"

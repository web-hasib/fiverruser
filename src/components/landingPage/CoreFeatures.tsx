...
export const coreFeatures: CoreFeature[] = [
  ...
  },
  {
    ...
    image: "/array.png",
    buttonText: "Apply Feature",
    buttonUrl: "/apply/secure-records",
  },
  {
    id: 3,
    step: "03 / 03",
...
const CoreFeatures = () => {
  ...
  return (
    <section className="bg-linear-to-br from-[#1344FE] to-[#01105B] py-12 md:py-16 px-4 overflow-hidden md:m-4 rounded-3xl">
